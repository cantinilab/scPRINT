...
class FinetuneBatchClass:
    def __init__(
        ...
        Args:
            ...
            emb_for_batchcorr (str, optional): The key of the embedding to be used for batch correction. Defaults to "cell_type_ontology_term_id".
            predictor (torch.nn.Module, optional): The predictor model to be used for batch classification. Defaults to None.
        ...
        self.emb_for_batchcorr = emb_for_batchcorr
